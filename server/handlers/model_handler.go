...
func (h *ModelHandler) ListTeacherModels(c *gin.Context) {
	models, err := h.modelSvc.ListTeacherModels(c.Request.Context())
	if err != nil {
...
func (h *ModelHandler) GetTeacherModel(c *gin.Context) {
	modelID := c.Param("id")
	if modelID == "" {
	...
	model, err := h.modelSvc.GetTeacherModel(c.Request.Context(), modelID)
	if err != nil {
